            ...
            <div className="flex flex-wrap gap-3 mb-3">
              {["Online", "Offline", "Both"].map((mode) => (
                <button
                  ...
                  className={`text-sm px-4 py-2 rounded-full border transition-colors ${
                    formData?.guideCard?.subCategory === mode
                      ? "bg-[#2F6288] text-white border-[#2F6288]"
                      : "bg-white text-gray-700 border-gray-300 hover:border-[#2F6288]"
                  }`}
                >
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                          ...
                          <div className="mt-2 flex items-center justify-between">
                            <label className="flex items-center gap-2 text-sm">
                              <input
                                ...
                                onChange={(e) =>
                                  setOtOnlineMulti(e.target.checked)
                                }
                              />
                        ...
                        <div className="border rounded-lg p-3">
                          <div className="font-semibold mb-2">
                            Slots for {otOnlineDate}
                          </div>
                          <div className="space-y-3">
                            {(formData?.online?.oneTime?.slots || [])
                              .filter((s) => ymd(s.date) === otOnlineDate)
                              .map((s, idx) => {
                                const slotType = s.type || "individual";
                                return (
                                  <div
                                    key={s.id || `${otOnlineDate}-${idx}`}
                ...
                <div className="mb-8">
                  ...
                  <div className="mt-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <div className="mt-2 flex items-center justify-between">
                          <label className="flex items-center gap-2 text-sm">
                            <input
                              ...
                              onChange={(e) =>
                                setOtOfflineMulti(e.target.checked)
                              }
                            />
                            <span>Multi-select dates</span>
                          </label>
                      ...
                      <div className="border rounded-lg p-3">
                        <div className="font-semibold mb-2">
                          Slots for {otOfflineDate}
                        </div>
                        <div className="space-y-3">
                          {(formData?.offline?.oneTime?.slots || [])
                            .filter((s) => ymd(s.date) === otOfflineDate)
                            .map((s, idx) => {
                              const slotType = s.type || "individual";
                              return (
                                <div
                                  key={s.id || `${otOfflineDate}-${idx}`}
                                  className="border rounded-lg p-3 space-y-2 bg-gray-50"
                                >
                                  <div className="flex items-center gap-4 mb-2">
                                    <label className="inline-flex items-center cursor-pointer">
