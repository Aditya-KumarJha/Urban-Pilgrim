...
export default function FilterBar({ onFiltersChange, initialFilters = {} }) {
    ...
    const [filterOptions] = useState({
        types: ['Retreat', 'Guide Session', 'Live Session', 'Recorded Session'],
        priceRanges: ['Free', 'Under ₹1,000', '₹1,000-₹5,000', '₹5,000-₹15,000', '₹15,000+'],
        locations: ['Online', 'Chandigarh', 'Rishikesh', 'Kangra', 'Varanasi', 'Others']
    });
