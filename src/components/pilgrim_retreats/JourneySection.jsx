    ...
    return (
        <div className="max-w-7xl mx-auto md:px-6 pt-0 pb-8 space-y-10 text-[#111]">
            ...
            <section className="space-y-4">
                <h2 className="md:text-2xl text-xl font-bold">{journey?.title || "The Journey Inward Begins"}</h2>
                <p className="text-sm">
                ...
                <p className="text-sm">
                    {journey?.description2
                        ? (() => {
                            const words = journey.description2.split(" ");
                            const firstFour = words.slice(0, 4).join(" ");
                            const rest = words.slice(4).join(" ");
                            return (
                                <>
                                    <strong>{firstFour}</strong> {rest}
                                </>
                            );
                        })()
                        : ""}
            ...
            <section className="space-y-4">
                ...
                <p className="text-sm">
                    {journey?.description3
                        ? (() => {
                            const words = journey.description3.split(" ");
                            const firstFour = words.slice(0, 4).join(" ");
                            const rest = words.slice(4).join(" ");
                            return (
                                <>
            ...
            <section className="space-y-4">
                {
                    retreatDescription && retreatDescription.map((desc, index) => (
