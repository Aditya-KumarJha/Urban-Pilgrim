      ...
      <div className="md:p-8 px-4 py-0 mx-auto">
        ...
        <div className="mb-4">
          ...
          <div className="flex flex-wrap gap-2 mb-2">
            {["Cultural and Heritage immersion", "Spiritual and wellness immersion"].map((cat, i) => (
              <button
                key={i}
                type="button"
                onClick={() => toggleCategory(cat)}
                className={`px-3 py-1 text-sm rounded-full border ${
                  formData.pilgrimRetreatCard.categories.includes(cat) ? "bg-blue-100 text-blue-700" : "bg-white"
                }`}
              >
                {cat}
              </button>
            ...
            <button
              ...
              onClick={() => {
                if (formData.customCategory?.trim()) {
                  toggleCategory(formData.customCategory.trim());
