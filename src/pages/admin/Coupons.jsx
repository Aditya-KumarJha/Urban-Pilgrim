...
export default function Coupons() {
  ...
  const [formData, setFormData] = useState({
    ...
    discountValue: '',
    programType: 'live_sessions', // live_sessions, recorded_sessions, retreats, guides
    minOrderAmount: '',
    maxDiscount: '',
    usageLimit: '',
    usedCount: 0,
  ...
  const programTypes = [
    ...
    { value: 'recorded_sessions', label: 'Recorded Sessions' },
    { value: 'retreats', label: 'Pilgrim Retreats' },
    { value: 'guides', label: 'Pilgrim Guides' }
  ];
